...
class GetMessagesRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack("<i", this.id.length),
      Buffer.concat(this.id.map((x) => x.getBytes())),
    ]);
  }
...
class GetDialogsRequest extends TLRequest {
  ...
  async resolve(client, utils) {
    this.offset_peer = utils.getInputPeer(
      await client.getInputEntity(this.offsetPeer)
    );
  }
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.excludePinned === undefined ||
          this.excludePinned === false ||
          this.excludePinned === null
          ? 0
          : 1 |
...
class SearchRequest extends TLRequest {
  ...
  async resolve(client, utils) {
    this.peer = utils.getInputPeer(await client.getInputEntity(this.peer));
    if (this.fromId) {
      this.from_id = utils.getInputUser(
        await client.getInputEntity(this.fromId)
      );
    }
  }
  getBytes() {
...
class ReadHistoryRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    _max_id = reader.readInt();
    return new this({ peer: _peer, maxId: _max_id });
  }
}
...
class DeleteMessagesRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.id.length),
      Buffer.concat(this.id.map((x) => struct.pack("<i", x))),
    ]);
  }
  static fromReader(reader) {
    let _flags;
    ...
    return new this({ revoke: _revoke, id: _id });
  }
}
...
class SetTypingRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ peer: _peer, action: _action });
  }
}
...
class SendMessageRequest extends TLRequest {
  ...
  async resolve(client, utils) {
    ...
    // console.log(utils);
    //fodendoTeste = await client.getInputEntity(this.peer);
    //fodendoTeste = utils.getInputPeer2(this.peer);
    //console.log("BATATA ASDASDAS " + utils.getInputPeer2());
    //let extraPeer = utils.getInputPeer2();
    //console.log("this.peer messages" + client.getInputEntity(765528516));
    this.peer = utils.getInputPeer(await client.getInputEntity(this.peer));
  }
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.noWebpage === undefined ||
          ...
          ? 0
          : 64 |
            (this.clearDraft === undefined ||
              this.clearDraft === false ||
              this.clearDraft === null)
          ? 0
          : 128 |
...
class ForwardMessagesRequest extends TLRequest {
  ...
  async resolve(client, utils) {
    this.from_peer = utils.getInputPeer(
      await client.getInputEntity(this.fromPeer)
    );
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.silent === undefined ||
          ...
          ? 0
          : 64 |
            (this.withMyScore === undefined ||
              this.withMyScore === false ||
              this.withMyScore === null)
          ? 0
          : 256 |
      ...
      Buffer.concat(this.id.map((x) => struct.pack("<i", x))),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.randomId.length),
      Buffer.concat(
        this.randomId.map((x) => readBufferFromBigInt(x, 8, true, true))
      ),
...
class ReportRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ peer: _peer, id: _id, reason: _reason });
  }
}
...
class EditChatTitleRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ chatId: _chat_id, title: _title });
  }
}
...
class EditChatPhotoRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ chatId: _chat_id, photo: _photo });
  }
}
...
class DeleteChatUserRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _chat_id = reader.readInt();
    _user_id = reader.tgReadObject();
    return new this({ chatId: _chat_id, userId: _user_id });
  }
}
...
class CreateChatRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _title = reader.tgReadString();
    return new this({ users: _users, title: _title });
  }
}
...
class GetDhConfigRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ version: _version, randomLength: _random_length });
  }
}
...
class RequestEncryptionRequest extends TLRequest {
  ...
  constructor(args) {
    ...
    this.randomId =
      args.randomId !== undefined
        ? args.randomId
        : readBigIntFromBuffer(generateRandomBytes(4), false, true);
    this.gA = args.gA;
  }
  async resolve(client, utils) {
    this.user_id = utils.getInputUser(await client.getInputEntity(this.userId));
  ...
  static fromReader(reader) {
    ...
    return new this({ userId: _user_id, randomId: _random_id, gA: _g_a });
  }
}
...
class SetEncryptedTypingRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ peer: _peer, typing: _typing });
  }
}
...
class ReadEncryptedHistoryRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    _max_date = reader.readInt();
    return new this({ peer: _peer, maxDate: _max_date });
  }
}
...
class SendEncryptedRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ peer: _peer, randomId: _random_id, data: _data });
  }
}
...
class GetStickersRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _hash = reader.readInt();
    return new this({ emoticon: _emoticon, hash: _hash });
  }
}
...
class GetWebPagePreviewRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ message: _message, entities: _entities });
  }
}
...
class InstallStickerSetRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ stickerset: _stickerset, archived: _archived });
  }
}
...
class GetMessagesViewsRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ peer: _peer, id: _id, increment: _increment });
  }
  readResult(reader) {
    reader.readInt(); // Vector ID
    let temp = [];
...
class EditChatAdminRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ chatId: _chat_id, userId: _user_id, isAdmin: _is_admin });
  }
}
...
class GetDocumentByHashRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ sha256: _sha256, size: _size, mimeType: _mime_type });
  }
}
...
class SearchGifsRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ q: _q, offset: _offset });
  }
}
...
class SaveGifRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ id: _id, unsave: _unsave });
  }
}
...
class SetInlineBotResultsRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.nextOffset === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.nextOffset)],
      this.switchPm === undefined ||
      this.switchPm === false ||
      this.switchPm === null
        ? Buffer.alloc(0)
...
class GetMessageEditDataRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    _id = reader.readInt();
    return new this({ peer: _peer, id: _id });
  }
}
...
class GetBotCallbackAnswerRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.game === undefined || this.game === false || this.game === null
          ? 0
          : 2 |
            (this.data === undefined ||
              this.data === false ||
  ...
  static fromReader(reader) {
    ...
    return new this({ game: _game, peer: _peer, msgId: _msg_id, data: _data });
  }
}
...
class SetBotCallbackAnswerRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.alert === undefined || this.alert === false || this.alert === null
          ? 0
          : 2 |
            (this.message === undefined ||
              this.message === false ||
...
class GetAllDraftsRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("658d3f6a", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class ReadFeaturedStickersRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.id.length),
      Buffer.concat(this.id.map((x) => readBufferFromBigInt(x, 8, true, true))),
    ]);
  }
  static fromReader(reader) {
    let _id;
...
class GetRecentStickersRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _hash = reader.readInt();
    return new this({ attached: _attached, hash: _hash });
  }
}
...
class SaveRecentStickerRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _id = reader.tgReadObject();
    _unsave = reader.tgReadBool();
    return new this({ attached: _attached, id: _id, unsave: _unsave });
  }
}
...
class GetArchivedStickersRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _limit = reader.readInt();
    return new this({ masks: _masks, offsetId: _offset_id, limit: _limit });
  }
}
...
class GetGameHighScoresRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _id = reader.readInt();
    _user_id = reader.tgReadObject();
    return new this({ peer: _peer, id: _id, userId: _user_id });
  }
}
...
class GetInlineGameHighScoresRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _id = reader.tgReadObject();
    _user_id = reader.tgReadObject();
    return new this({ id: _id, userId: _user_id });
  }
}
...
class GetCommonChatsRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _max_id = reader.readInt();
    _limit = reader.readInt();
    return new this({ userId: _user_id, maxId: _max_id, limit: _limit });
  }
}
...
class GetAllChatsRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.exceptIds.length),
      Buffer.concat(this.exceptIds.map((x) => struct.pack("<i", x))),
    ]);
  }
  static fromReader(reader) {
    let _except_ids;
...
class GetWebPageRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _url = reader.tgReadString();
    _hash = reader.readInt();
    return new this({ url: _url, hash: _hash });
  }
}
...
class ToggleDialogPinRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    return new this({ pinned: _pinned, peer: _peer });
  }
}
...
class ReorderPinnedDialogsRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.force === undefined || this.force === false || this.force === null
          ? 0
          : 1
      ),
      struct.pack("<i", this.folderId),
  ...
  static fromReader(reader) {
    ...
    return new this({ force: _force, folderId: _folder_id, order: _order });
  }
}
...
class SetBotShippingResultsRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.error === undefined || this.error === false || this.error === null
          ? 0
          : 1 |
            (this.shippingOptions === undefined ||
      ...
      this.error === undefined || this.error === false || this.error === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.error)],
      this.shippingOptions === undefined ||
      this.shippingOptions === false ||
      this.shippingOptions === null
        ? Buffer.alloc(0)
        : Buffer.concat([
            Buffer.from("15c4b51c", "hex"),
            struct.pack("<i", this.shippingOptions.length),
            Buffer.concat(this.shippingOptions.map((x) => x.getBytes())),
          ]),
    ]);
  }
  static fromReader(reader) {
...
class SetBotPrecheckoutResultsRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ success: _success, queryId: _query_id, error: _error });
  }
}
...
class UploadMediaRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    _media = reader.tgReadObject();
    return new this({ peer: _peer, media: _media });
  }
}
...
class FaveStickerRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ id: _id, unfave: _unfave });
  }
}
...
class GetRecentLocationsRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _limit = reader.readInt();
    _hash = reader.readInt();
    return new this({ peer: _peer, limit: _limit, hash: _hash });
  }
}
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.replyToMsgId === null
        ...
        : [struct.pack("<i", this.replyToMsgId)],
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.multiMedia.length),
      Buffer.concat(this.multiMedia.map((x) => x.getBytes())),
      this.scheduleDate === undefined ||
      this.scheduleDate === false ||
      this.scheduleDate === null
        ? Buffer.alloc(0)
...
class UploadEncryptedFileRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    _file = reader.tgReadObject();
    return new this({ peer: _peer, file: _file });
  }
}
...
class SearchStickerSetsRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.excludeFeatured === undefined ||
          this.excludeFeatured === false ||
          this.excludeFeatured === null
          ? 0
          : 1
      ),
      TLObject.serializeBytes(this.q),
  ...
  static fromReader(reader) {
    ...
    _q = reader.tgReadString();
    _hash = reader.readInt();
    return new this({ excludeFeatured: _exclude_featured, q: _q, hash: _hash });
  }
}
...
class GetSplitRangesRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("087eff1c", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class GetDialogUnreadMarksRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("224ee222", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class ClearAllDraftsRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("9cee587e", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UpdatePinnedMessageRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    _id = reader.readInt();
    return new this({ silent: _silent, peer: _peer, id: _id });
  }
}
...
class SendVoteRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack("<i", this.msgId),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.options.length),
      Buffer.concat(this.options.map((x) => TLObject.serializeBytes(x))),
    ]);
  }
  static fromReader(reader) {
    let _peer;
    ...
    return new this({ peer: _peer, msgId: _msg_id, options: _options });
  }
}
...
class GetPollResultsRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    _msg_id = reader.readInt();
    return new this({ peer: _peer, msgId: _msg_id });
  }
}
...
class GetStatsURLRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.dark === undefined || this.dark === false || this.dark === null
          ? 0
          : 1
      ),
      this.peer.getBytes(),
  ...
  static fromReader(reader) {
    ...
    return new this({ dark: _dark, peer: _peer, params: _params });
  }
}
...
class EditChatAboutRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ peer: _peer, about: _about });
  }
}
...
class EditChatDefaultBannedRightsRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ peer: _peer, bannedRights: _banned_rights });
  }
}
...
class GetEmojiKeywordsDifferenceRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ langCode: _lang_code, fromVersion: _from_version });
  }
}
...
class GetEmojiKeywordsLanguagesRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.langCodes.length),
      Buffer.concat(this.langCodes.map((x) => TLObject.serializeBytes(x))),
    ]);
  }
  static fromReader(reader) {
    let _lang_codes;
...
class GetSearchCountersRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.peer.getBytes(),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.filters.length),
      Buffer.concat(this.filters.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _peer;
    ...
    return new this({ peer: _peer, filters: _filters });
  }
}
...
class RequestUrlAuthRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    return new this({ peer: _peer, msgId: _msg_id, buttonId: _button_id });
  }
}
...
class AcceptUrlAuthRequest extends TLRequest {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.writeAllowed === undefined ||
          this.writeAllowed === false ||
          this.writeAllowed === null
          ? 0
          : 1
      ),
      this.peer.getBytes(),
...
class GetScheduledHistoryRequest extends TLRequest {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    _hash = reader.readInt();
    return new this({ peer: _peer, hash: _hash });
  }
}
