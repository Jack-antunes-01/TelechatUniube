...
class InputPeerEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("ea183b7f", "hex")]);
  }
...
class InputPeerSelf extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("c97ea07d", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPeerUser extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ userId: _user_id, accessHash: _access_hash });
  }
}
...
class InputPeerChannel extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _access_hash = reader.readLong();
    return new this({ channelId: _channel_id, accessHash: _access_hash });
  }
}
...
class InputPeerUserFromMessage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _user_id = reader.readInt();
    return new this({ peer: _peer, msgId: _msg_id, userId: _user_id });
  }
}
...
class InputPeerChannelFromMessage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _msg_id = reader.readInt();
    _channel_id = reader.readInt();
    return new this({ peer: _peer, msgId: _msg_id, channelId: _channel_id });
  }
}
...
class InputUserEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("cf8688b9", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputUserSelf extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("3fb1c1f7", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputFileBig extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _parts = reader.readInt();
    _name = reader.tgReadString();
    return new this({ id: _id, parts: _parts, name: _name });
  }
}
...
class InputMediaEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("7ff56496", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.stickers === null
        ? Buffer.alloc(0)
        : Buffer.concat([
            Buffer.from("15c4b51c", "hex"),
            struct.pack("<i", this.stickers.length),
            Buffer.concat(this.stickers.map((x) => x.getBytes())),
          ]),
      this.ttlSeconds === undefined ||
      this.ttlSeconds === false ||
      this.ttlSeconds === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.ttlSeconds)],
    ]);
  }
  static fromReader(reader) {
    let _flags;
...
class InputMediaPhoto extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ id: _id, ttlSeconds: _ttl_seconds });
  }
}
...
class InputMediaUploadedDocument extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.nosoundVideo === undefined ||
          this.nosoundVideo === false ||
          this.nosoundVideo === null
          ? 0
          : 8 |
      ...
      this.file.getBytes(),
      this.thumb === undefined || this.thumb === false || this.thumb === null
        ? Buffer.alloc(0)
        : [this.thumb.getBytes()],
      TLObject.serializeBytes(this.mimeType),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.attributes.length),
      Buffer.concat(this.attributes.map((x) => x.getBytes())),
      this.stickers === undefined ||
      this.stickers === false ||
      this.stickers === null
        ? Buffer.alloc(0)
...
class InputMediaPhotoExternal extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ url: _url, ttlSeconds: _ttl_seconds });
  }
}
...
class InputMediaGame extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("f3433fd3", "hex"), this.id.getBytes()]);
  }
  static fromReader(reader) {
    let _id;
    let _x;
...
class InputMediaInvoice extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.photo === undefined || this.photo === false || this.photo === null
          ? 0
          : 1
      ),
      TLObject.serializeBytes(this.title),
...
class InputMediaGeoLive extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.geoPoint.getBytes(),
      this.period === undefined || this.period === false || this.period === null
        ? Buffer.alloc(0)
...
class InputChatPhotoEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("578fa41c", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputChatPhoto extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("37ad5389", "hex"), this.id.getBytes()]);
  }
  static fromReader(reader) {
    let _id;
    let _x;
...
class InputGeoPointEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("d623c1e4", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputGeoPoint extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ lat: _lat, long: _long });
  }
}
...
class InputPhotoEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("0dbfd71c", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputEncryptedFileLocation extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _id = reader.readLong();
    _access_hash = reader.readLong();
    return new this({ id: _id, accessHash: _access_hash });
  }
}
...
class InputTakeoutFileLocation extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("9958be29", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPeerPhotoFileLocation extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.big === undefined || this.big === false || this.big === null
          ? 0
          : 1
      ),
      this.peer.getBytes(),
...
class User extends TLObject {
  ...
  getBytes() {
    if (
      !(
        (this.bot ||
          (this.bot !== null && this.bot_info_version) ||
          this.bot_info_version !== null) &&
        (this.bot === null ||
          (this.bot === false && this.bot_info_version === null) ||
          this.bot_info_version === false)
      )
    )
      throw new Error(
        "bot, bot_info_version paramaters must all be false-y or all true"
      );
    if (
      !(
        (this.restricted ||
          (this.restricted !== null && this.restriction_reason) ||
          this.restriction_reason !== null) &&
        (this.restricted === null ||
          (this.restricted === false && this.restriction_reason === null) ||
          this.restriction_reason === false)
      )
    )
      throw new Error(
        "restricted, restriction_reason paramaters must all be false-y or all true"
      );
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.isSelf === undefined ||
          ...
          ? 0
          : 2048 |
            (this.mutualContact === undefined ||
              this.mutualContact === false ||
              this.mutualContact === null)
          ? 0
          : 4096 |
          ...
          ? 0
          : 8192 |
            (this.bot === undefined || this.bot === false || this.bot === null)
          ? 0
          : 16384 |
            (this.botChatHistory === undefined ||
              this.botChatHistory === false ||
              this.botChatHistory === null)
          ? 0
          : 32768 |
            (this.botNochats === undefined ||
              this.botNochats === false ||
              this.botNochats === null)
          ? 0
          : 65536 |
          ...
          ? 0
          : 262144 |
            (this.min === undefined || this.min === false || this.min === null)
          ? 0
          : 1048576 |
            (this.botInlineGeo === undefined ||
              this.botInlineGeo === false ||
              this.botInlineGeo === null)
          ? 0
          : 2097152 |
          ...
          ? 0
          : 16777216 |
            (this.accessHash === undefined ||
              this.accessHash === false ||
          ...
          ? 0
          : 64 |
            (this.botInfoVersion === undefined ||
              this.botInfoVersion === false ||
              this.botInfoVersion === null)
          ? 0
          : 16384 |
            (this.restrictionReason === undefined ||
              this.restrictionReason === false ||
              this.restrictionReason === null)
          ? 0
          : 262144 |
            (this.botInlinePlaceholder === undefined ||
              this.botInlinePlaceholder === false ||
      ...
      this.phone === undefined || this.phone === false || this.phone === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.phone)],
      this.photo === undefined || this.photo === false || this.photo === null
        ? Buffer.alloc(0)
        : [this.photo.getBytes()],
      this.status === undefined || this.status === false || this.status === null
        ? Buffer.alloc(0)
      ...
      this.botInfoVersion === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.botInfoVersion)],
      this.restrictionReason === undefined ||
      this.restrictionReason === false ||
      this.restrictionReason === null
        ? Buffer.alloc(0)
        : Buffer.concat([
            Buffer.from("15c4b51c", "hex"),
            struct.pack("<i", this.restrictionReason.length),
            Buffer.concat(this.restrictionReason.map((x) => x.getBytes())),
          ]),
      this.botInlinePlaceholder === undefined ||
      this.botInlinePlaceholder === false ||
      this.botInlinePlaceholder === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.botInlinePlaceholder)],
      this.langCode === undefined ||
      this.langCode === false ||
      this.langCode === null
        ? Buffer.alloc(0)
...
class UserProfilePhotoEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("e1ba114f", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UserStatusEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("4950d009", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UserStatusRecently extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("f1426fe2", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UserStatusLastWeek extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("fc09bf07", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UserStatusLastMonth extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("42c7eb77", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.creator === undefined ||
          ...
          ? 0
          : 32 |
            (this.migratedTo === undefined ||
              this.migratedTo === false ||
          ...
          ? 0
          : 16384 |
            (this.defaultBannedRights === undefined ||
              this.defaultBannedRights === false ||
...
class ChatForbidden extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _id = reader.readInt();
    _title = reader.tgReadString();
    return new this({ id: _id, title: _title });
  }
}
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.creator === undefined ||
          ...
          ? 0
          : 128 |
            (this.megagroup === undefined ||
              this.megagroup === false ||
              this.megagroup === null)
          ? 0
          : 256 |
            (this.restricted === undefined ||
          ...
          ? 0
          : 1048576 |
            (this.hasGeo === undefined ||
              this.hasGeo === false ||
              this.hasGeo === null)
          ? 0
          : 2097152 |
            (this.slowmodeEnabled === undefined ||
              this.slowmodeEnabled === false ||
              this.slowmodeEnabled === null)
          ? 0
          : 4194304 |
            (this.accessHash === undefined ||
              this.accessHash === false ||
          ...
          ? 0
          : 16384 |
            (this.bannedRights === undefined ||
              this.bannedRights === false ||
...
class ChatFull extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.canSetUsername === undefined ||
          this.canSetUsername === false ||
          this.canSetUsername === null
          ? 0
          : 128 |
            (this.hasScheduled === undefined ||
              this.hasScheduled === false ||
              this.hasScheduled === null)
          ? 0
          : 256 |
            (this.chatPhoto === undefined ||
              this.chatPhoto === false ||
              this.chatPhoto === null)
          ? 0
          : 4 |
          ...
          ? 0
          : 8 |
            (this.pinnedMsgId === undefined ||
              this.pinnedMsgId === false ||
      ...
      this.botInfo === null
        ...
        : Buffer.concat([
            Buffer.from("15c4b51c", "hex"),
            struct.pack("<i", this.botInfo.length),
            Buffer.concat(this.botInfo.map((x) => x.getBytes())),
          ]),
      this.pinnedMsgId === undefined ||
      this.pinnedMsgId === false ||
      this.pinnedMsgId === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.pinnedMsgId)],
      this.folderId === undefined ||
      this.folderId === false ||
      this.folderId === null
        ? Buffer.alloc(0)
...
class ChannelFull extends TLObject {
  ...
  getBytes() {
    if (
      !(
        (this.kicked_count ||
          (this.kicked_count !== null && this.banned_count) ||
          this.banned_count !== null) &&
        (this.kicked_count === null ||
          (this.kicked_count === false && this.banned_count === null) ||
          this.banned_count === false)
      )
    )
      throw new Error(
        "kicked_count, banned_count paramaters must all be false-y or all true"
      );
    if (
      !(
        (this.migrated_from_chat_id ||
          (this.migrated_from_chat_id !== null && this.migrated_from_max_id) ||
          this.migrated_from_max_id !== null) &&
        (this.migrated_from_chat_id === null ||
          (this.migrated_from_chat_id === false &&
            this.migrated_from_max_id === null) ||
          this.migrated_from_max_id === false)
      )
    )
      throw new Error(
        "migrated_from_chat_id, migrated_from_max_id paramaters must all be false-y or all true"
      );
    return Buffer.concat([
      Buffer.from("745c892d", "hex"),
      struct.pack(
        "<I",
        this.canViewParticipants === undefined ||
          this.canViewParticipants === false ||
          this.canViewParticipants === null
          ? 0
          : 8 |
            (this.canSetUsername === undefined ||
              this.canSetUsername === false ||
          ...
          ? 0
          : 64 |
            (this.canSetStickers === undefined ||
              this.canSetStickers === false ||
              this.canSetStickers === null)
          ? 0
          : 128 |
            (this.hiddenPrehistory === undefined ||
              this.hiddenPrehistory === false ||
              this.hiddenPrehistory === null)
          ? 0
          : 1024 |
            (this.canViewStats === undefined ||
              this.canViewStats === false ||
              this.canViewStats === null)
          ? 0
          : 4096 |
            (this.canSetLocation === undefined ||
              this.canSetLocation === false ||
              this.canSetLocation === null)
          ? 0
          : 65536 |
            (this.hasScheduled === undefined ||
              this.hasScheduled === false ||
          ...
          ? 0
          : 1 |
            (this.adminsCount === undefined ||
              this.adminsCount === false ||
              this.adminsCount === null)
          ? 0
          : 2 |
            (this.kickedCount === undefined ||
              this.kickedCount === false ||
              this.kickedCount === null)
          ? 0
          : 4 |
            (this.bannedCount === undefined ||
              this.bannedCount === false ||
              this.bannedCount === null)
          ? 0
          : 4 |
            (this.onlineCount === undefined ||
              this.onlineCount === false ||
              this.onlineCount === null)
          ? 0
          : 8192 |
            (this.migratedFromChatId === undefined ||
              this.migratedFromChatId === false ||
              this.migratedFromChatId === null)
          ? 0
          : 16 |
            (this.migratedFromMaxId === undefined ||
              this.migratedFromMaxId === false ||
          ...
          ? 0
          : 32 |
            (this.stickerset === undefined ||
              this.stickerset === false ||
              this.stickerset === null)
          ? 0
          : 256 |
            (this.availableMinId === undefined ||
              this.availableMinId === false ||
          ...
          ? 0
          : 32768 |
            (this.slowmodeSeconds === undefined ||
              this.slowmodeSeconds === false ||
              this.slowmodeSeconds === null)
          ? 0
          : 131072 |
            (this.slowmodeNextSendDate === undefined ||
              this.slowmodeNextSendDate === false ||
      ...
      this.adminsCount === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.adminsCount)],
      this.kickedCount === undefined ||
      this.kickedCount === false ||
      this.kickedCount === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.kickedCount)],
      this.bannedCount === undefined ||
      this.bannedCount === false ||
      this.bannedCount === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.bannedCount)],
      this.onlineCount === undefined ||
      this.onlineCount === false ||
      this.onlineCount === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.onlineCount)],
      ...
      this.migratedFromChatId === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.migratedFromChatId)],
      this.migratedFromMaxId === undefined ||
      this.migratedFromMaxId === false ||
      this.migratedFromMaxId === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.migratedFromMaxId)],
      this.pinnedMsgId === undefined ||
      this.pinnedMsgId === false ||
      this.pinnedMsgId === null
        ? Buffer.alloc(0)
      ...
      this.linkedChatId === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.linkedChatId)],
      this.location === undefined ||
      this.location === false ||
      this.location === null
        ? Buffer.alloc(0)
      ...
      this.slowmodeSeconds === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.slowmodeSeconds)],
      this.slowmodeNextSendDate === undefined ||
      this.slowmodeNextSendDate === false ||
      this.slowmodeNextSendDate === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.slowmodeNextSendDate)],
  ...
  static fromReader(reader) {
    ...
    _pts = reader.readInt();
    return new this({
      canViewParticipants: _can_view_participants,
      canSetUsername: _can_set_username,
...
class ChatParticipant extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _date = reader.readInt();
    return new this({ userId: _user_id, inviterId: _inviter_id, date: _date });
  }
}
...
class ChatParticipantsForbidden extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ chatId: _chat_id, selfParticipant: _self_participant });
  }
}
...
class ChatParticipants extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack("<i", this.chatId),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.participants.length),
      Buffer.concat(this.participants.map((x) => x.getBytes())),
      struct.pack("<i", this.version),
    ]);
  }
  static fromReader(reader) {
...
class ChatPhotoEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("1c01c137", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class Message extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.out === undefined || this.out === false || this.out === null
          ? 0
          : 2 |
          ...
          ? 0
          : 16 |
            (this.mediaUnread === undefined ||
              this.mediaUnread === false ||
              this.mediaUnread === null)
          ? 0
          : 32 |
          ...
          ? 0
          : 16384 |
            (this.fromScheduled === undefined ||
              this.fromScheduled === false ||
              this.fromScheduled === null)
          ? 0
          : 262144 |
          ...
          ? 0
          : 256 |
            (this.fwdFrom === undefined ||
              this.fwdFrom === false ||
              this.fwdFrom === null)
          ? 0
          : 4 |
            (this.viaBotId === undefined ||
              this.viaBotId === false ||
              this.viaBotId === null)
          ? 0
          : 2048 |
            (this.replyToMsgId === undefined ||
              this.replyToMsgId === false ||
          ...
          : 32768 |
            (this.postAuthor === undefined ||
              this.postAuthor === false ||
              this.postAuthor === null)
          ? 0
          : 65536 |
            (this.groupedId === undefined ||
              this.groupedId === false ||
              this.groupedId === null)
          ? 0
          : 131072 |
            (this.restrictionReason === undefined ||
      ...
      struct.pack("<i", this.id),
      this.fromId === undefined || this.fromId === false || this.fromId === null
        ? Buffer.alloc(0)
      ...
      this.fwdFrom === null
        ? Buffer.alloc(0)
        : [this.fwdFrom.getBytes()],
      this.viaBotId === undefined ||
      this.viaBotId === false ||
      this.viaBotId === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.viaBotId)],
      this.replyToMsgId === undefined ||
      this.replyToMsgId === false ||
      this.replyToMsgId === null
        ? Buffer.alloc(0)
      ...
      this.media === undefined || this.media === false || this.media === null
        ? Buffer.alloc(0)
        : [this.media.getBytes()],
      this.replyMarkup === undefined ||
      this.replyMarkup === false ||
      ...
      this.entities === null
        ...
        : Buffer.concat([
            Buffer.from("15c4b51c", "hex"),
            struct.pack("<i", this.entities.length),
            Buffer.concat(this.entities.map((x) => x.getBytes())),
          ]),
      this.views === undefined || this.views === false || this.views === null
        ? Buffer.alloc(0)
      ...
      this.editDate === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.editDate)],
      this.postAuthor === undefined ||
      this.postAuthor === false ||
      this.postAuthor === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.postAuthor)],
      this.groupedId === undefined ||
      this.groupedId === false ||
      this.groupedId === null
        ? Buffer.alloc(0)
        : [readBufferFromBigInt(this.groupedId, 8, true, true)],
      this.restrictionReason === undefined ||
      this.restrictionReason === false ||
      this.restrictionReason === null
        ? Buffer.alloc(0)
...
class MessageMediaEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("2063ed3d", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class MessageMediaPhoto extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ photo: _photo, ttlSeconds: _ttl_seconds });
  }
}
...
class MessageMediaGeo extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("74d4e056", "hex"), this.geo.getBytes()]);
  }
  static fromReader(reader) {
    let _geo;
    let _x;
...
class MessageMediaUnsupported extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("9ef4849f", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class MessageMediaDocument extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ document: _document, ttlSeconds: _ttl_seconds });
  }
}
...
class MessageMediaInvoice extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.shippingAddressRequested === undefined ||
          this.shippingAddressRequested === false ||
          this.shippingAddressRequested === null
          ? 0
          : 2 |
            (this.test === undefined ||
              this.test === false ||
          ...
          ? 0
          : 1 |
            (this.receiptMsgId === undefined ||
              this.receiptMsgId === false ||
      ...
      this.receiptMsgId === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.receiptMsgId)],
...
class MessageMediaGeoLive extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _geo = reader.tgReadObject();
    _period = reader.readInt();
    return new this({ geo: _geo, period: _period });
  }
}
...
class MessageMediaPoll extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ poll: _poll, results: _results });
  }
}
...
class MessageActionEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("b0f7aeb6", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class MessageActionChatCreate extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      TLObject.serializeBytes(this.title),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.users.length),
      Buffer.concat(this.users.map((x) => struct.pack("<i", x))),
    ]);
  }
  static fromReader(reader) {
    let _title;
    ...
    return new this({ title: _title, users: _users });
  }
}
...
class MessageActionChatDeletePhoto extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("effbe395", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class MessageActionChannelMigrateFrom extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _title = reader.tgReadString();
    _chat_id = reader.readInt();
    return new this({ title: _title, chatId: _chat_id });
  }
}
...
class MessageActionPinMessage extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("ed38bd94", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class MessageActionHistoryClear extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("04b6ba9f", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class MessageActionGameScore extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ gameId: _game_id, score: _score });
  }
}
...
class MessageActionPaymentSentMe extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.info === undefined || this.info === false || this.info === null
          ? 0
          : 1 |
            (this.shippingOptionId === undefined ||
              this.shippingOptionId === false ||
      ...
      this.shippingOptionId === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.shippingOptionId)],
...
class MessageActionPaymentSent extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _currency = reader.tgReadString();
    _total_amount = reader.readLong();
    return new this({ currency: _currency, totalAmount: _total_amount });
  }
}
...
class MessageActionPhoneCall extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.video === undefined || this.video === false || this.video === null
          ? 0
          : 4 |
      ...
      this.reason === undefined || this.reason === false || this.reason === null
        ? Buffer.alloc(0)
...
class MessageActionScreenshotTaken extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("9b929247", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class MessageActionSecureValuesSentMe extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.values.length),
      Buffer.concat(this.values.map((x) => x.getBytes())),
  ...
  static fromReader(reader) {
    ...
    return new this({ values: _values, credentials: _credentials });
  }
}
...
class MessageActionSecureValuesSent extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.types.length),
      Buffer.concat(this.types.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _types;
...
class MessageActionContactSignUp extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("765ff2f3", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.pinned === undefined ||
          ...
          ? 0
          : 4 |
            (this.unreadMark === undefined ||
              this.unreadMark === false ||
              this.unreadMark === null)
          ? 0
          : 8 |
            (this.pts === undefined || this.pts === false || this.pts === null)
          ? 0
          : 1 |
      ...
      this.pts === undefined || this.pts === false || this.pts === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.pts)],
      this.draft === undefined || this.draft === false || this.draft === null
        ? Buffer.alloc(0)
        : [this.draft.getBytes()],
      this.folderId === undefined ||
      this.folderId === false ||
...
class Photo extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.hasStickers === undefined ||
          this.hasStickers === false ||
          this.hasStickers === null
          ? 0
          : 1
      ),
      readBufferFromBigInt(this.id, 8, true, true),
      ...
      struct.pack("<i", this.date),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.sizes.length),
      Buffer.concat(this.sizes.map((x) => x.getBytes())),
      struct.pack("<i", this.dcId),
    ]);
  }
  static fromReader(reader) {
...
class PhotoStrippedSize extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _type = reader.tgReadString();
    _bytes = reader.tgReadBytes();
    return new this({ type: _type, bytes: _bytes });
  }
}
...
class GeoPointEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("5fdd1711", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class GeoPoint extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _lat = reader.readDouble();
    _access_hash = reader.readLong();
    return new this({ long: _long, lat: _lat, accessHash: _access_hash });
  }
}
...
class InputNotifyUsers extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("17443b19", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputNotifyChats extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("4ee8954a", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputNotifyBroadcasts extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("7e7cdbb1", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPeerNotifySettings extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.showPreviews === null
        ? Buffer.alloc(0)
        : [this.showPreviews ? 0xb5757299 : 0x379779bc],
      this.silent === undefined || this.silent === false || this.silent === null
        ? Buffer.alloc(0)
      ...
      this.muteUntil === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.muteUntil)],
      this.sound === undefined || this.sound === false || this.sound === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.sound)],
    ]);
  }
  static fromReader(reader) {
    let _flags;
        ...
        this.reportSpam === undefined ||
          ...
          : 2 |
            (this.blockContact === undefined ||
              this.blockContact === false ||
              this.blockContact === null)
          ? 0
          : 4 |
            (this.shareContact === undefined ||
              this.shareContact === false ||
              this.shareContact === null)
          ? 0
          : 8 |
            (this.needContactsException === undefined ||
              this.needContactsException === false ||
              this.needContactsException === null)
          ? 0
          : 16 |
            (this.reportGeo === undefined ||
...
class InputReportReasonSpam extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("b8cadb58", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputReportReasonViolence extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("8dc7221e", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputReportReasonPornography extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("22d9592e", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputReportReasonChildAbuse extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("e34ef4ad", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputReportReasonCopyright extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("3af9899b", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputReportReasonGeoIrrelevant extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("edfed4db", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.blocked === undefined ||
          ...
          ? 0
          : 1 |
            (this.phoneCallsAvailable === undefined ||
              this.phoneCallsAvailable === false ||
              this.phoneCallsAvailable === null)
          ? 0
          : 16 |
            (this.phoneCallsPrivate === undefined ||
              this.phoneCallsPrivate === false ||
              this.phoneCallsPrivate === null)
          ? 0
          : 32 |
            (this.canPinMessage === undefined ||
              this.canPinMessage === false ||
              this.canPinMessage === null)
          ? 0
          : 128 |
            (this.hasScheduled === undefined ||
              this.hasScheduled === false ||
      ...
      this.user.getBytes(),
      this.about === undefined || this.about === false || this.about === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.about)],
      this.settings.getBytes(),
      this.profilePhoto === undefined ||
      ...
      this.profilePhoto === null
        ? Buffer.alloc(0)
        : [this.profilePhoto.getBytes()],
      this.notifySettings.getBytes(),
      this.botInfo === undefined ||
      this.botInfo === false ||
      this.botInfo === null
        ? Buffer.alloc(0)
        : [this.botInfo.getBytes()],
      this.pinnedMsgId === undefined ||
      this.pinnedMsgId === false ||
      this.pinnedMsgId === null
        ? Buffer.alloc(0)
...
class Contact extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ userId: _user_id, mutual: _mutual });
  }
}
...
class ImportedContact extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _user_id = reader.readInt();
    _client_id = reader.readLong();
    return new this({ userId: _user_id, clientId: _client_id });
  }
}
...
class ContactBlocked extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _user_id = reader.readInt();
    _date = reader.readInt();
    return new this({ userId: _user_id, date: _date });
  }
}
...
class ContactStatus extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _user_id = reader.readInt();
    _status = reader.tgReadObject();
    return new this({ userId: _user_id, status: _status });
  }
}
...
class InputMessagesFilterEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("6cf6e257", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterPhotos extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("1ca50996", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterVideo extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("650ec09f", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterPhotoVideo extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("e4f0e956", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterDocument extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("88f1dd9e", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterUrl extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("87ddf07e", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterGif extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("8765c8ff", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterVoice extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("92c3f550", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterMusic extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("9eb45137", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterChatPhotos extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("b8ec203a", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterRoundVoice extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("a4177c7a", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterRoundVideo extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("53da49b5", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterMyMentions extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("9ae6f8c1", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterGeo extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("0d6d02e7", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputMessagesFilterContacts extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("83db62e0", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UpdateNewMessage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ message: _message, pts: _pts, ptsCount: _pts_count });
  }
}
...
class UpdateMessageID extends TLObject {
  ...
  constructor(args) {
    ...
    this.id = args.id;
    this.randomId =
      args.randomId !== undefined
        ? args.randomId
        : readBigIntFromBuffer(generateRandomBytes(8), false, true);
  }
  getBytes() {
    return Buffer.concat([
  ...
  static fromReader(reader) {
    ...
    return new this({ id: _id, randomId: _random_id });
  }
}
...
class UpdateDeleteMessages extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.messages.length),
      Buffer.concat(this.messages.map((x) => struct.pack("<i", x))),
      struct.pack("<i", this.pts),
      struct.pack("<i", this.ptsCount),
    ]);
  }
  static fromReader(reader) {
    ...
    _pts = reader.readInt();
    _pts_count = reader.readInt();
    return new this({ messages: _messages, pts: _pts, ptsCount: _pts_count });
  }
}
...
class UpdateUserTyping extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _user_id = reader.readInt();
    _action = reader.tgReadObject();
    return new this({ userId: _user_id, action: _action });
  }
}
...
class UpdateChatUserTyping extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _user_id = reader.readInt();
    _action = reader.tgReadObject();
    return new this({ chatId: _chat_id, userId: _user_id, action: _action });
  }
}
...
class UpdateNewEncryptedMessage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _message = reader.tgReadObject();
    _qts = reader.readInt();
    return new this({ message: _message, qts: _qts });
  }
}
...
class UpdateEncryption extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _date = reader.readInt();
    return new this({ chat: _chat, date: _date });
  }
}
...
class UpdateEncryptedMessagesRead extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _date = reader.readInt();
    return new this({ chatId: _chat_id, maxDate: _max_date, date: _date });
  }
}
...
class UpdateChatParticipantDelete extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _user_id = reader.readInt();
    _version = reader.readInt();
    return new this({ chatId: _chat_id, userId: _user_id, version: _version });
  }
}
...
class UpdateDcOptions extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.dcOptions.length),
      Buffer.concat(this.dcOptions.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _dc_options;
...
class UpdateUserBlocked extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ userId: _user_id, blocked: _blocked });
  }
}
...
class UpdateNotifySettings extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    _notify_settings = reader.tgReadObject();
    return new this({ peer: _peer, notifySettings: _notify_settings });
  }
}
...
class UpdateServiceNotification extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.popup === undefined || this.popup === false || this.popup === null
          ? 0
          : 1 |
            (this.inboxDate === undefined ||
              this.inboxDate === false ||
              this.inboxDate === null)
          ? 0
          : 2
      ),
...
class UpdatePrivacy extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.key.getBytes(),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.rules.length),
      Buffer.concat(this.rules.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _key;
    ...
    return new this({ key: _key, rules: _rules });
  }
}
...
class UpdateUserPhone extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _user_id = reader.readInt();
    _phone = reader.tgReadString();
    return new this({ userId: _user_id, phone: _phone });
  }
}
...
class UpdateWebPage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _pts = reader.readInt();
    _pts_count = reader.readInt();
    return new this({ webpage: _webpage, pts: _pts, ptsCount: _pts_count });
  }
}
...
class UpdateChannelTooLong extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ channelId: _channel_id, pts: _pts });
  }
}
...
class UpdateChannelMessageViews extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _id = reader.readInt();
    _views = reader.readInt();
    return new this({ channelId: _channel_id, id: _id, views: _views });
  }
}
...
class UpdateStickerSetsOrder extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.masks === undefined || this.masks === false || this.masks === null
          ? 0
          : 1
      ),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.order.length),
      Buffer.concat(
        this.order.map((x) => readBufferFromBigInt(x, 8, true, true))
      ),
    ]);
  }
  static fromReader(reader) {
    ...
    return new this({ masks: _masks, order: _order });
  }
}
...
class UpdateStickerSets extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("ec3dae43", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UpdateSavedGifs extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("1e347593", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UpdateBotInlineQuery extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.geo === undefined || this.geo === false || this.geo === null
          ? 0
          : 1
      ),
...
class UpdateBotInlineSend extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.msgId === undefined || this.msgId === false || this.msgId === null
        ? Buffer.alloc(0)
        : [this.msgId.getBytes()],
    ]);
  }
...
class UpdateChannelPinnedMessage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _channel_id = reader.readInt();
    _id = reader.readInt();
    return new this({ channelId: _channel_id, id: _id });
  }
}
...
class UpdateBotCallbackQuery extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.data === undefined || this.data === false || this.data === null
          ? 0
          : 1 |
            (this.gameShortName === undefined ||
              this.gameShortName === false ||
      ...
      this.gameShortName === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.gameShortName)],
    ]);
  }
  static fromReader(reader) {
    let _flags;
...
class UpdateReadChannelOutbox extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _channel_id = reader.readInt();
    _max_id = reader.readInt();
    return new this({ channelId: _channel_id, maxId: _max_id });
  }
}
...
class UpdateDraftMessage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    _draft = reader.tgReadObject();
    return new this({ peer: _peer, draft: _draft });
  }
}
...
class UpdateReadFeaturedStickers extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("42271d57", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UpdateRecentStickers extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("202c429a", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UpdateConfig extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("06dd29a2", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UpdatePtsChanged extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("8f675433", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UpdateDialogPinned extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    return new this({ pinned: _pinned, folderId: _folder_id, peer: _peer });
  }
}
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.folderId === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.folderId)],
      this.order === undefined || this.order === false || this.order === null
        ? Buffer.alloc(0)
        : Buffer.concat([
            Buffer.from("15c4b51c", "hex"),
            struct.pack("<i", this.order.length),
            Buffer.concat(this.order.map((x) => x.getBytes())),
          ]),
    ]);
  }
  static fromReader(reader) {
    ...
    return new this({ folderId: _folder_id, order: _order });
  }
}
...
class UpdateBotWebhookJSONQuery extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ queryId: _query_id, data: _data, timeout: _timeout });
  }
}
...
class UpdateFavedStickers extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("6d9911e5", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UpdateChannelReadMessagesContents extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ channelId: _channel_id, messages: _messages });
  }
}
...
class UpdateContactsReset extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("bea78470", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UpdateDialogUnreadMark extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    return new this({ unread: _unread, peer: _peer });
  }
}
...
class UpdateUserPinnedMessage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _user_id = reader.readInt();
    _id = reader.readInt();
    return new this({ userId: _user_id, id: _id });
  }
}
...
class UpdateChatPinnedMessage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _id = reader.readInt();
    _version = reader.readInt();
    return new this({ chatId: _chat_id, id: _id, version: _version });
  }
}
...
class UpdateMessagePoll extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.poll === undefined || this.poll === false || this.poll === null
          ? 0
          : 1
      ),
  ...
  static fromReader(reader) {
    ...
    _results = reader.tgReadObject();
    return new this({ pollId: _poll_id, poll: _poll, results: _results });
  }
}
...
class UpdateFolderPeers extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.folderPeers.length),
      Buffer.concat(this.folderPeers.map((x) => x.getBytes())),
      struct.pack("<i", this.pts),
      struct.pack("<i", this.ptsCount),
    ]);
  }
...
class UpdatePeerSettings extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    _settings = reader.tgReadObject();
    return new this({ peer: _peer, settings: _settings });
  }
}
...
class UpdatePeerLocated extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.peers.length),
      Buffer.concat(this.peers.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _peers;
...
class UpdateDeleteScheduledMessages extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ peer: _peer, messages: _messages });
  }
}
...
class UpdatesTooLong extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("7eaf17e3", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class UpdateShort extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _date = reader.readInt();
    return new this({ update: _update, date: _date });
  }
}
...
class UpdatesCombined extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.updates.length),
      Buffer.concat(this.updates.map((x) => x.getBytes())),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.users.length),
      Buffer.concat(this.users.map((x) => x.getBytes())),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.chats.length),
      Buffer.concat(this.chats.map((x) => x.getBytes())),
      struct.pack("<i", this.date),
...
class DcOption extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.ipv6 === undefined || this.ipv6 === false || this.ipv6 === null
          ? 0
          : 1 |
            (this.mediaOnly === undefined ||
              this.mediaOnly === false ||
              this.mediaOnly === null)
          ? 0
          : 2 |
            (this.tcpoOnly === undefined ||
              this.tcpoOnly === false ||
              this.tcpoOnly === null)
          ? 0
          : 4 |
            (this.cdn === undefined || this.cdn === false || this.cdn === null)
          ? 0
          : 8 |
      ...
      this.secret === undefined || this.secret === false || this.secret === null
        ? Buffer.alloc(0)
...
class Config extends TLObject {
  ...
  getBytes() {
    if (
      !(
        (this.suggested_lang_code ||
          (this.suggested_lang_code !== null && this.lang_pack_version) ||
          (this.lang_pack_version !== null && this.base_lang_pack_version) ||
          this.base_lang_pack_version !== null) &&
        (this.suggested_lang_code === null ||
          (this.suggested_lang_code === false &&
            this.lang_pack_version === null) ||
          (this.lang_pack_version === false &&
            this.base_lang_pack_version === null) ||
          this.base_lang_pack_version === false)
      )
    )
      throw new Error(
        "suggested_lang_code, lang_pack_version, base_lang_pack_version paramaters must all be false-y or all true"
      );
    return Buffer.concat([
      Buffer.from("67400b33", "hex"),
      struct.pack(
        "<I",
        this.phonecallsEnabled === undefined ||
          this.phonecallsEnabled === false ||
          this.phonecallsEnabled === null
          ? 0
          : 2 |
            (this.defaultP2pContacts === undefined ||
              this.defaultP2pContacts === false ||
              this.defaultP2pContacts === null)
          ? 0
          : 8 |
            (this.preloadFeaturedStickers === undefined ||
              this.preloadFeaturedStickers === false ||
              this.preloadFeaturedStickers === null)
          ? 0
          : 16 |
            (this.ignorePhoneEntities === undefined ||
              this.ignorePhoneEntities === false ||
              this.ignorePhoneEntities === null)
          ? 0
          : 32 |
            (this.revokePmInbox === undefined ||
              this.revokePmInbox === false ||
              this.revokePmInbox === null)
          ? 0
          : 64 |
            (this.blockedMode === undefined ||
              this.blockedMode === false ||
              this.blockedMode === null)
          ? 0
          : 256 |
            (this.pfsEnabled === undefined ||
              this.pfsEnabled === false ||
              this.pfsEnabled === null)
          ? 0
          : 8192 |
            (this.tmpSessions === undefined ||
              this.tmpSessions === false ||
              this.tmpSessions === null)
          ? 0
          : 1 |
            (this.autoupdateUrlPrefix === undefined ||
              this.autoupdateUrlPrefix === false ||
              this.autoupdateUrlPrefix === null)
          ? 0
          : 128 |
            (this.gifSearchUsername === undefined ||
              this.gifSearchUsername === false ||
              this.gifSearchUsername === null)
          ? 0
          : 512 |
            (this.venueSearchUsername === undefined ||
              this.venueSearchUsername === false ||
              this.venueSearchUsername === null)
          ? 0
          : 1024 |
            (this.imgSearchUsername === undefined ||
              this.imgSearchUsername === false ||
              this.imgSearchUsername === null)
          ? 0
          : 2048 |
            (this.staticMapsProvider === undefined ||
              this.staticMapsProvider === false ||
              this.staticMapsProvider === null)
          ? 0
          : 4096 |
            (this.suggestedLangCode === undefined ||
              this.suggestedLangCode === false ||
              this.suggestedLangCode === null)
          ? 0
          : 4 |
            (this.langPackVersion === undefined ||
              this.langPackVersion === false ||
              this.langPackVersion === null)
          ? 0
          : 4 |
            (this.baseLangPackVersion === undefined ||
              this.baseLangPackVersion === false ||
      ...
      this.tmpSessions === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.tmpSessions)],
      ...
      this.autoupdateUrlPrefix === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.autoupdateUrlPrefix)],
      this.gifSearchUsername === undefined ||
      this.gifSearchUsername === false ||
      this.gifSearchUsername === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.gifSearchUsername)],
      this.venueSearchUsername === undefined ||
      this.venueSearchUsername === false ||
      this.venueSearchUsername === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.venueSearchUsername)],
      this.imgSearchUsername === undefined ||
      this.imgSearchUsername === false ||
      this.imgSearchUsername === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.imgSearchUsername)],
      this.staticMapsProvider === undefined ||
      this.staticMapsProvider === false ||
      this.staticMapsProvider === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.staticMapsProvider)],
      ...
      this.suggestedLangCode === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.suggestedLangCode)],
      this.langPackVersion === undefined ||
      this.langPackVersion === false ||
      this.langPackVersion === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.langPackVersion)],
      this.baseLangPackVersion === undefined ||
      this.baseLangPackVersion === false ||
      this.baseLangPackVersion === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.baseLangPackVersion)],
    ]);
  }
  static fromReader(reader) {
    let _flags;
    ...
    return new this({
      phonecallsEnabled: _phonecalls_enabled,
...
class InputEncryptedChat extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _chat_id = reader.readInt();
    _access_hash = reader.readLong();
    return new this({ chatId: _chat_id, accessHash: _access_hash });
  }
}
...
class EncryptedFileEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("7e491fc2", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputEncryptedFileEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("64c33718", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputDocumentEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("aeeaf072", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class Document extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      TLObject.serializeBytes(this.mimeType),
      struct.pack("<i", this.size),
      this.thumbs === undefined || this.thumbs === false || this.thumbs === null
        ? Buffer.alloc(0)
        : Buffer.concat([
            Buffer.from("15c4b51c", "hex"),
            struct.pack("<i", this.thumbs.length),
            Buffer.concat(this.thumbs.map((x) => x.getBytes())),
          ]),
      struct.pack("<i", this.dcId),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.attributes.length),
...
class NotifyUsers extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("4c3bc8b4", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class NotifyChats extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("c3ce07c0", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class NotifyBroadcasts extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("efe812d6", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SendMessageTypingAction extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("4e74bf16", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SendMessageCancelAction extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("f5c85efd", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SendMessageRecordVideoAction extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("6fd687a1", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SendMessageRecordAudioAction extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("f7732fd5", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SendMessageGeoLocationAction extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("a18b6f17", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SendMessageChooseContactAction extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("6fbc8c62", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SendMessageGamePlayAction extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("488f6add", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SendMessageRecordRoundAction extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("bc7ff288", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyKeyStatusTimestamp extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("18cb964f", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyKeyChatInvite extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("2604fbbd", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyKeyPhoneCall extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("5fdcbafa", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyKeyPhoneP2P extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("d2709edb", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyKeyForwards extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("084cdda4", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyKeyProfilePhoto extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("ccba1957", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyKeyPhoneNumber extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("fada5203", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyKeyAddedByPhone extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("dd9b21d1", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PrivacyKeyStatusTimestamp extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("30ab2ebc", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PrivacyKeyChatInvite extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("fa6d0e50", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PrivacyKeyPhoneCall extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("7b2b663d", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PrivacyKeyPhoneP2P extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("c81c4939", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PrivacyKeyForwards extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("a356ec69", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PrivacyKeyProfilePhoto extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("ed1f1596", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PrivacyKeyPhoneNumber extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("6de49ad1", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PrivacyKeyAddedByPhone extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("2bd4ff42", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyValueAllowContacts extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("7be0090d", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyValueAllowAll extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("ce354b18", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyValueDisallowContacts extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("0720a50b", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyValueDisallowAll extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("c9666bd6", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputPrivacyValueAllowChatParticipants extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.chats.length),
      Buffer.concat(this.chats.map((x) => struct.pack("<i", x))),
    ]);
  }
  static fromReader(reader) {
    let _chats;
...
class PrivacyValueAllowContacts extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("ac1bfeff", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PrivacyValueAllowAll extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("827b4265", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PrivacyValueDisallowContacts extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("1afa88f8", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PrivacyValueDisallowAll extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("63e7738b", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class DocumentAttributeAnimated extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("3989b511", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class DocumentAttributeSticker extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.mask === undefined || this.mask === false || this.mask === null
          ? 0
          : 2 |
            (this.maskCoords === undefined ||
              this.maskCoords === false ||
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.roundMessage === undefined ||
          this.roundMessage === false ||
          this.roundMessage === null
          ? 0
          : 1 |
            (this.supportsStreaming === undefined ||
...
class DocumentAttributeAudio extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.voice === undefined || this.voice === false || this.voice === null
          ? 0
          : 1024 |
      ...
      struct.pack("<i", this.duration),
      this.title === undefined || this.title === false || this.title === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.title)],
      this.performer === undefined ||
      this.performer === false ||
      this.performer === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.performer)],
      this.waveform === undefined ||
      this.waveform === false ||
      this.waveform === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.waveform)],
    ]);
  }
  static fromReader(reader) {
    let _flags;
...
class DocumentAttributeHasStickers extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("f7d20198", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class StickerPack extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.documents.length),
      Buffer.concat(
        this.documents.map((x) => readBufferFromBigInt(x, 8, true, true))
      ),
    ]);
  }
  static fromReader(reader) {
    ...
    return new this({ emoticon: _emoticon, documents: _documents });
  }
}
...
class WebPagePending extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _id = reader.readLong();
    _date = reader.readInt();
    return new this({ id: _id, date: _date });
  }
}
...
class WebPage extends TLObject {
  ...
  getBytes() {
    if (
      !(
        (this.embed_url ||
          (this.embed_url !== null && this.embed_type) ||
          this.embed_type !== null) &&
        (this.embed_url === null ||
          (this.embed_url === false && this.embed_type === null) ||
          this.embed_type === false)
      )
    )
      throw new Error(
        "embed_url, embed_type paramaters must all be false-y or all true"
      );
    if (
      !(
        (this.embed_width ||
          (this.embed_width !== null && this.embed_height) ||
          this.embed_height !== null) &&
        (this.embed_width === null ||
          (this.embed_width === false && this.embed_height === null) ||
          this.embed_height === false)
      )
    )
      throw new Error(
        "embed_width, embed_height paramaters must all be false-y or all true"
      );
    return Buffer.concat([
      Buffer.from("72e164fa", "hex"),
      struct.pack(
        "<I",
        this.type === undefined || this.type === false || this.type === null
          ? 0
          : 1 |
          ...
          : 32 |
            (this.embedType === undefined ||
              this.embedType === false ||
              this.embedType === null)
          ? 0
          : 32 |
            (this.embedWidth === undefined ||
              this.embedWidth === false ||
              this.embedWidth === null)
          ? 0
          : 64 |
            (this.embedHeight === undefined ||
              this.embedHeight === false ||
      ...
      this.siteName === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.siteName)],
      this.title === undefined || this.title === false || this.title === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.title)],
      this.description === undefined ||
      ...
      this.embedUrl === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.embedUrl)],
      this.embedType === undefined ||
      this.embedType === false ||
      this.embedType === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.embedType)],
      this.embedWidth === undefined ||
      this.embedWidth === false ||
      this.embedWidth === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.embedWidth)],
      this.embedHeight === undefined ||
      this.embedHeight === false ||
      this.embedHeight === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.embedHeight)],
      this.duration === undefined ||
      this.duration === false ||
      this.duration === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.duration)],
      this.author === undefined || this.author === false || this.author === null
        ? Buffer.alloc(0)
      ...
      this.documents === null
        ...
        : Buffer.concat([
            Buffer.from("15c4b51c", "hex"),
            struct.pack("<i", this.documents.length),
            Buffer.concat(this.documents.map((x) => x.getBytes())),
          ]),
      this.cachedPage === undefined ||
      this.cachedPage === false ||
      this.cachedPage === null
        ? Buffer.alloc(0)
        : [this.cachedPage.getBytes()],
    ]);
  }
  static fromReader(reader) {
    let _flags;
...
class WebPageNotModified extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("73948485", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.current === undefined ||
          ...
          ? 0
          : 1 |
            (this.officialApp === undefined ||
              this.officialApp === false ||
              this.officialApp === null)
          ? 0
          : 2 |
            (this.passwordPending === undefined ||
...
class ReceivedNotifyMessage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ id: _id, flags: _flags });
  }
}
...
class ChatInviteEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("6937df69", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputStickerSetEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("952bb6ff", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputStickerSetAnimatedEmoji extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("c8038702", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class StickerSet extends TLObject {
  ...
  getBytes() {
    if (
      !(
        (this.thumb ||
          (this.thumb !== null && this.thumb_dc_id) ||
          this.thumb_dc_id !== null) &&
        (this.thumb === null ||
          (this.thumb === false && this.thumb_dc_id === null) ||
          this.thumb_dc_id === false)
      )
    )
      throw new Error(
        "thumb, thumb_dc_id paramaters must all be false-y or all true"
      );
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.archived === undefined ||
          ...
          ? 0
          : 32 |
            (this.installedDate === undefined ||
              this.installedDate === false ||
          ...
          ? 0
          : 16 |
            (this.thumbDcId === undefined ||
              this.thumbDcId === false ||
              this.thumbDcId === null)
          ? 0
          : 16
      ),
      ...
      this.installedDate === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.installedDate)],
      readBufferFromBigInt(this.id, 8, true, true),
      readBufferFromBigInt(this.accessHash, 8, true, true),
      TLObject.serializeBytes(this.title),
      TLObject.serializeBytes(this.shortName),
...
class BotCommand extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _description = reader.tgReadString();
    return new this({ command: _command, description: _description });
  }
}
...
class BotInfo extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      TLObject.serializeBytes(this.description),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.commands.length),
      Buffer.concat(this.commands.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _user_id;
...
class KeyboardButtonUrl extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _text = reader.tgReadString();
    _url = reader.tgReadString();
    return new this({ text: _text, url: _url });
  }
}
...
class KeyboardButtonCallback extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _text = reader.tgReadString();
    _data = reader.tgReadBytes();
    return new this({ text: _text, data: _data });
  }
}
...
class KeyboardButtonSwitchInline extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _text = reader.tgReadString();
    _query = reader.tgReadString();
    return new this({ samePeer: _same_peer, text: _text, query: _query });
  }
}
...
class KeyboardButtonUrlAuth extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.fwdText === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.fwdText)],
      TLObject.serializeBytes(this.url),
...
class InputKeyboardButtonUrlAuth extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.requestWriteAccess === undefined ||
  ...
  static fromReader(reader) {
    ...
    return new this({
      requestWriteAccess: _request_write_access,
      text: _text,
      fwdText: _fwd_text,
      url: _url,
      bot: _bot,
...
class KeyboardButtonRow extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.buttons.length),
      Buffer.concat(this.buttons.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _buttons;
...
class ReplyKeyboardForceReply extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _selective = Boolean(flags & 4);
    return new this({ singleUse: _single_use, selective: _selective });
  }
}
...
class ReplyKeyboardMarkup extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.rows.length),
      Buffer.concat(this.rows.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _flags;
...
class MessageEntityUnknown extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ offset: _offset, length: _length });
  }
}
...
class MessageEntityPre extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ offset: _offset, length: _length, language: _language });
  }
}
...
class MessageEntityTextUrl extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _length = reader.readInt();
    _url = reader.tgReadString();
    return new this({ offset: _offset, length: _length, url: _url });
  }
}
...
class MessageEntityMentionName extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _length = reader.readInt();
    _user_id = reader.readInt();
    return new this({ offset: _offset, length: _length, userId: _user_id });
  }
}
...
class InputChannelEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("861e8cee", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class MessageRange extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _max_id = reader.readInt();
    return new this({ minId: _min_id, maxId: _max_id });
  }
}
...
class ChannelMessagesFilterEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("e72ed494", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class ChannelMessagesFilter extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.excludeNewMessages === undefined ||
          this.excludeNewMessages === false ||
          this.excludeNewMessages === null
          ? 0
          : 2
      ),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.ranges.length),
      Buffer.concat(this.ranges.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _flags;
    ...
    return new this({
      excludeNewMessages: _exclude_new_messages,
      ranges: _ranges,
    });
  }
}
...
class ChannelParticipantCreator extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.rank === undefined || this.rank === false || this.rank === null
          ? 0
          : 1
      ),
      struct.pack("<i", this.userId),
  ...
  static fromReader(reader) {
    ...
    return new this({ userId: _user_id, rank: _rank });
  }
}
...
class ChannelParticipantAdmin extends TLObject {
  ...
  getBytes() {
    if (
      !(
        (this.is_self ||
          (this.is_self !== null && this.inviter_id) ||
          this.inviter_id !== null) &&
        (this.is_self === null ||
          (this.is_self === false && this.inviter_id === null) ||
          this.inviter_id === false)
      )
    )
      throw new Error(
        "is_self, inviter_id paramaters must all be false-y or all true"
      );
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.canEdit === undefined ||
          ...
          ? 0
          : 2 |
            (this.inviterId === undefined ||
              this.inviterId === false ||
              this.inviterId === null)
          ? 0
          : 2 |
            (this.rank === undefined ||
...
class ChannelParticipantBanned extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.left === undefined || this.left === false || this.left === null
          ? 0
          : 1
      ),
      struct.pack("<i", this.userId),
...
class ChannelParticipantsRecent extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("793c3fde", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class ChannelParticipantsAdmins extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("698960b4", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class ChannelParticipantsBots extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("5b86d1b0", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class FoundGifCached extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _photo = reader.tgReadObject();
    _document = reader.tgReadObject();
    return new this({ url: _url, photo: _photo, document: _document });
  }
}
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.title === undefined || this.title === false || this.title === null
          ...
          ? 0
          : 4 |
            (this.url === undefined || this.url === false || this.url === null)
          ? 0
          : 8 |
            (this.thumb === undefined ||
              this.thumb === false ||
...
class BotInlineMessageMediaGeo extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ geo: _geo, period: _period, replyMarkup: _reply_markup });
  }
}
...
class ExportedMessageLink extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ link: _link, html: _html });
  }
}
...
class MessageFwdHeader extends TLObject {
  ...
  getBytes() {
    if (
      !(
        (this.saved_from_peer ||
          (this.saved_from_peer !== null && this.saved_from_msg_id) ||
          this.saved_from_msg_id !== null) &&
        (this.saved_from_peer === null ||
          (this.saved_from_peer === false && this.saved_from_msg_id === null) ||
          this.saved_from_msg_id === false)
      )
    )
      throw new Error(
        "saved_from_peer, saved_from_msg_id paramaters must all be false-y or all true"
      );
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.fromId === undefined ||
          ...
          ? 0
          : 8 |
            (this.savedFromPeer === undefined ||
              this.savedFromPeer === false ||
              this.savedFromPeer === null)
          ? 0
          : 16 |
            (this.savedFromMsgId === undefined ||
              this.savedFromMsgId === false ||
      ...
      this.fromName === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.fromName)],
      struct.pack("<i", this.date),
      this.channelId === undefined ||
      this.channelId === false ||
      this.channelId === null
      ...
      this.channelPost === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.channelPost)],
      this.postAuthor === undefined ||
      this.postAuthor === false ||
      this.postAuthor === null
        ? Buffer.alloc(0)
      ...
      this.savedFromPeer === null
        ? Buffer.alloc(0)
        : [this.savedFromPeer.getBytes()],
      this.savedFromMsgId === undefined ||
      this.savedFromMsgId === false ||
      this.savedFromMsgId === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.savedFromMsgId)],
    ]);
  }
  static fromReader(reader) {
    let _flags;
...
class InputBotInlineMessageID extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _id = reader.readLong();
    _access_hash = reader.readLong();
    return new this({ dcId: _dc_id, id: _id, accessHash: _access_hash });
  }
}
...
class InlineBotSwitchPM extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _text = reader.tgReadString();
    _start_param = reader.tgReadString();
    return new this({ text: _text, startParam: _start_param });
  }
}
...
class TopPeer extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ peer: _peer, rating: _rating });
  }
}
...
class TopPeerCategoryBotsPM extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("5b1b66ab", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class TopPeerCategoryBotsInline extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("e2778614", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class TopPeerCategoryCorrespondents extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("edb73706", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class TopPeerCategoryGroups extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("4aa117bd", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class TopPeerCategoryChannels extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("28961d16", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class TopPeerCategoryPhoneCalls extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("8ca7761e", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class TopPeerCategoryForwardUsers extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("a96c40a8", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class TopPeerCategoryForwardChats extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("f0c0eefb", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class TopPeerCategoryPeers extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ category: _category, count: _count, peers: _peers });
  }
}
...
class DraftMessageEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.date === undefined || this.date === false || this.date === null
          ? 0
          : 1
      ),
      this.date === undefined || this.date === false || this.date === null
...
class StickerSetCovered extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ set: _set, cover: _cover });
  }
}
...
class StickerSetMultiCovered extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.set.getBytes(),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.covers.length),
      Buffer.concat(this.covers.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _set;
    ...
    return new this({ set: _set, covers: _covers });
  }
}
...
class MaskCoords extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ n: _n, x: _x, y: _y, zoom: _zoom });
  }
}
...
class InputStickeredMediaPhoto extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("5721994a", "hex"), this.id.getBytes()]);
  }
  static fromReader(reader) {
    let _id;
    let _x;
...
class InputStickeredMediaDocument extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("5b863804", "hex"), this.id.getBytes()]);
  }
  static fromReader(reader) {
    let _id;
    let _x;
...
class InputGameShortName extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _short_name = reader.tgReadString();
    return new this({ botId: _bot_id, shortName: _short_name });
  }
}
...
class HighScore extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _user_id = reader.readInt();
    _score = reader.readInt();
    return new this({ pos: _pos, userId: _user_id, score: _score });
  }
}
...
class TextEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("4f823ddc", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class TextUrl extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ text: _text, url: _url, webpageId: _webpage_id });
  }
}
...
class TextEmail extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ text: _text, email: _email });
  }
}
...
class TextConcat extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.texts.length),
      Buffer.concat(this.texts.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _texts;
...
class TextPhone extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _text = reader.tgReadObject();
    _phone = reader.tgReadString();
    return new this({ text: _text, phone: _phone });
  }
}
...
class TextImage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _w = reader.readInt();
    _h = reader.readInt();
    return new this({ documentId: _document_id, w: _w, h: _h });
  }
}
...
class TextAnchor extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _text = reader.tgReadObject();
    _name = reader.tgReadString();
    return new this({ text: _text, name: _name });
  }
}
...
class PageBlockUnsupported extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("8a7e5613", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PageBlockAuthorDate extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ author: _author, publishedDate: _published_date });
  }
}
...
class PageBlockPreformatted extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _text = reader.tgReadObject();
    _language = reader.tgReadString();
    return new this({ text: _text, language: _language });
  }
}
...
class PageBlockDivider extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("88b120db", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PageBlockList extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.items.length),
      Buffer.concat(this.items.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _items;
...
class PageBlockBlockquote extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ text: _text, caption: _caption });
  }
}
...
class PageBlockPhoto extends TLObject {
  ...
  getBytes() {
    if (
      !(
        (this.url ||
          (this.url !== null && this.webpage_id) ||
          this.webpage_id !== null) &&
        (this.url === null ||
          (this.url === false && this.webpage_id === null) ||
          this.webpage_id === false)
      )
    )
      throw new Error(
        "url, webpage_id paramaters must all be false-y or all true"
      );
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.url === undefined || this.url === false || this.url === null
          ? 0
          : 1 |
            (this.webpageId === undefined ||
              this.webpageId === false ||
              this.webpageId === null)
          ? 0
          : 1
      ),
...
class PageBlockEmbed extends TLObject {
  ...
  getBytes() {
    if (
      !(
        (this.w || (this.w !== null && this.h) || this.h !== null) &&
        (this.w === null ||
          (this.w === false && this.h === null) ||
          this.h === false)
      )
    )
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.fullWidth === undefined ||
          ...
          ? 0
          : 1 |
            (this.allowScrolling === undefined ||
              this.allowScrolling === false ||
              this.allowScrolling === null)
          ? 0
          : 8 |
            (this.url === undefined || this.url === false || this.url === null)
          ? 0
          ...
          ? 0
          : 4 |
            (this.posterPhotoId === undefined ||
              this.posterPhotoId === false ||
              this.posterPhotoId === null)
          ? 0
          : 16 | (this.w === undefined || this.w === false || this.w === null)
          ? 0
          : 32 | (this.h === undefined || this.h === false || this.h === null)
          ? 0
          : 32
      ),
      this.url === undefined || this.url === false || this.url === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.url)],
      this.html === undefined || this.html === false || this.html === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.html)],
      this.posterPhotoId === undefined ||
      this.posterPhotoId === false ||
      this.posterPhotoId === null
        ? Buffer.alloc(0)
        : [readBufferFromBigInt(this.posterPhotoId, 8, true, true)],
      this.w === undefined || this.w === false || this.w === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.w)],
      this.h === undefined || this.h === false || this.h === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.h)],
      this.caption.getBytes(),
    ]);
...
class PageBlockEmbedPost extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack("<i", this.date),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.blocks.length),
      Buffer.concat(this.blocks.map((x) => x.getBytes())),
      this.caption.getBytes(),
    ]);
  }
  static fromReader(reader) {
...
class PageBlockCollage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _caption = reader.tgReadObject();
    return new this({ items: _items, caption: _caption });
  }
}
...
class PageBlockAudio extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _caption = reader.tgReadObject();
    return new this({ audioId: _audio_id, caption: _caption });
  }
}
...
class PageBlockDetails extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.open === undefined || this.open === false || this.open === null
          ? 0
          : 1
      ),
      Buffer.from("15c4b51c", "hex"),
  ...
  static fromReader(reader) {
    ...
    _title = reader.tgReadObject();
    return new this({ open: _open, blocks: _blocks, title: _title });
  }
}
...
class PageBlockRelatedArticles extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.title.getBytes(),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.articles.length),
      Buffer.concat(this.articles.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _title;
    ...
    return new this({ title: _title, articles: _articles });
  }
}
...
class PhoneCallDiscardReasonMissed extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("0123e485", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PhoneCallDiscardReasonDisconnect extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("a0c195e0", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PhoneCallDiscardReasonHangup extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("90c6ad57", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PhoneCallDiscardReasonBusy extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("c9e8f7fa", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class LabeledPrice extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ label: _label, amount: _amount });
  }
}
...
class Invoice extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.test === undefined || this.test === false || this.test === null
          ? 0
          : 1 |
            (this.nameRequested === undefined ||
              this.nameRequested === false ||
              this.nameRequested === null)
          ? 0
          : 2 |
            (this.phoneRequested === undefined ||
              this.phoneRequested === false ||
              this.phoneRequested === null)
          ? 0
          : 4 |
            (this.emailRequested === undefined ||
              this.emailRequested === false ||
              this.emailRequested === null)
          ? 0
          : 8 |
            (this.shippingAddressRequested === undefined ||
              this.shippingAddressRequested === false ||
          ...
          ? 0
          : 32 |
            (this.phoneToProvider === undefined ||
              this.phoneToProvider === false ||
              this.phoneToProvider === null)
          ? 0
          : 64 |
            (this.emailToProvider === undefined ||
              this.emailToProvider === false ||
              this.emailToProvider === null)
          ? 0
          : 128
      ),
      TLObject.serializeBytes(this.currency),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.prices.length),
      Buffer.concat(this.prices.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _flags;
...
class PaymentCharge extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ id: _id, providerChargeId: _provider_charge_id });
  }
}
...
class PaymentRequestedInfo extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.name === undefined || this.name === false || this.name === null
          ? 0
          : 1 |
            (this.phone === undefined ||
              this.phone === false ||
      ...
      this.phone === undefined || this.phone === false || this.phone === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.phone)],
      this.email === undefined || this.email === false || this.email === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.email)],
      this.shippingAddress === undefined ||
      this.shippingAddress === false ||
...
class InputWebFileLocation extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _url = reader.tgReadString();
    _access_hash = reader.readLong();
    return new this({ url: _url, accessHash: _access_hash });
  }
}
...
class InputPaymentCredentialsSaved extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ id: _id, tmpPassword: _tmp_password });
  }
}
...
class InputPaymentCredentials extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.save === undefined || this.save === false || this.save === null
          ? 0
          : 1
      ),
      this.data.getBytes(),
  ...
  static fromReader(reader) {
    ...
    _data = reader.tgReadObject();
    return new this({ save: _save, data: _data });
  }
}
...
class ShippingOption extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ id: _id, title: _title, prices: _prices });
  }
}
...
class PhoneCallWaiting extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.receiveDate === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.receiveDate)],
    ]);
  }
  static fromReader(reader) {
    let _flags;
...
class PhoneCall extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.p2pAllowed === undefined ||
          this.p2pAllowed === false ||
          this.p2pAllowed === null
          ? 0
          : 32
      ),
      readBufferFromBigInt(this.id, 8, true, true),
      ...
      this.protocol.getBytes(),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.connections.length),
      Buffer.concat(this.connections.map((x) => x.getBytes())),
...
class PhoneCallDiscarded extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.needRating === undefined ||
          this.needRating === false ||
          this.needRating === null
          ? 0
          : 4 |
            (this.needDebug === undefined ||
...
class PhoneCallProtocol extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.udpP2p === undefined ||
          this.udpP2p === false ||
          this.udpP2p === null
          ? 0
          : 1 |
            (this.udpReflector === undefined ||
              this.udpReflector === false ||
              this.udpReflector === null)
          ? 0
          : 2
      ),
...
class CdnPublicKey extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ dcId: _dc_id, publicKey: _public_key });
  }
}
...
class CdnConfig extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.publicKeys.length),
      Buffer.concat(this.publicKeys.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _public_keys;
...
class LangPackString extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ key: _key, value: _value });
  }
}
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.zeroValue === undefined ||
          ...
          ? 0
          : 2 |
            (this.twoValue === undefined ||
              this.twoValue === false ||
              this.twoValue === null)
          ? 0
          : 4 |
            (this.fewValue === undefined ||
              this.fewValue === false ||
              this.fewValue === null)
          ? 0
          : 8 |
            (this.manyValue === undefined ||
              this.manyValue === false ||
              this.manyValue === null)
          ? 0
          : 16
      ),
      ...
      this.zeroValue === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.zeroValue)],
      this.oneValue === undefined ||
      this.oneValue === false ||
      this.oneValue === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.oneValue)],
      this.twoValue === undefined ||
      this.twoValue === false ||
      this.twoValue === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.twoValue)],
      this.fewValue === undefined ||
      this.fewValue === false ||
      this.fewValue === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.fewValue)],
      this.manyValue === undefined ||
      this.manyValue === false ||
      this.manyValue === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.manyValue)],
...
class LangPackDifference extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack("<i", this.version),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.strings.length),
      Buffer.concat(this.strings.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _lang_code;
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.official === undefined ||
          ...
          ? 0
          : 1 |
            (this.rtl === undefined || this.rtl === false || this.rtl === null)
          ? 0
          : 4 |
            (this.beta === undefined ||
              this.beta === false ||
          ...
          ? 0
          : 8 |
            (this.baseLangCode === undefined ||
              this.baseLangCode === false ||
      ...
      this.baseLangCode === null
        ? Buffer.alloc(0)
        : [TLObject.serializeBytes(this.baseLangCode)],
...
class ChannelAdminLogEventActionChangeTitle extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ prevValue: _prev_value, newValue: _new_value });
  }
}
...
class ChannelAdminLogEventActionChangePhoto extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ prevPhoto: _prev_photo, newPhoto: _new_photo });
  }
}
...
class ChannelAdminLogEventActionEditMessage extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ prevMessage: _prev_message, newMessage: _new_message });
  }
}
...
class ChannelAdminLogEventActionParticipantJoin extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("d3403018", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class ChannelAdminLogEventActionParticipantLeave extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("f27797f8", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class ChannelAdminLogEventActionParticipantToggleBan extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({
      prevParticipant: _prev_participant,
...
class ChannelAdminLogEventActionChangeStickerSet extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({
      prevStickerset: _prev_stickerset,
...
class ChannelAdminLogEventActionDefaultBannedRights extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({
      prevBannedRights: _prev_banned_rights,
...
class ChannelAdminLogEventsFilter extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.join === undefined || this.join === false || this.join === null
          ? 0
          : 1 |
          ...
          ? 0
          : 4 |
            (this.ban === undefined || this.ban === false || this.ban === null)
          ? 0
          : 8 |
            (this.unban === undefined ||
              this.unban === false ||
              this.unban === null)
          ? 0
          : 16 |
...
class PopularContact extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ clientId: _client_id, importers: _importers });
  }
}
...
class RecentMeUrlUser extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _url = reader.tgReadString();
    _user_id = reader.readInt();
    return new this({ url: _url, userId: _user_id });
  }
}
...
class RecentMeUrlChat extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _url = reader.tgReadString();
    _chat_id = reader.readInt();
    return new this({ url: _url, chatId: _chat_id });
  }
}
...
class RecentMeUrlChatInvite extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ url: _url, chatInvite: _chat_invite });
  }
}
...
class RecentMeUrlStickerSet extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _url = reader.tgReadString();
    _set = reader.tgReadObject();
    return new this({ url: _url, set: _set });
  }
}
...
class InputMessagePinned extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("38258786", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class FileHash extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ offset: _offset, limit: _limit, hash: _hash });
  }
}
...
class InputClientProxy extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _address = reader.tgReadString();
    _port = reader.readInt();
    return new this({ address: _address, port: _port });
  }
}
...
class SecureFileEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("44971964", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureData extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _secret = reader.tgReadBytes();
    return new this({ data: _data, dataHash: _data_hash, secret: _secret });
  }
}
...
class SecureValueTypePersonalDetails extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("e3812a9d", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureValueTypePassport extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("006aac3d", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureValueTypeDriverLicense extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("c425e406", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureValueTypeIdentityCard extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("4b74d0a0", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureValueTypeInternalPassport extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("238fa499", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureValueTypeAddress extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("261ee3cb", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureValueTypeUtilityBill extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("4e9536fc", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureValueTypeBankStatement extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("0d7c1389", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureValueTypeRentalAgreement extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("8834888b", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureValueTypePassportRegistration extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("6a80e399", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureValueTypeTemporaryRegistration extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("33ec02ea", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureValueTypePhone extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("dbaa20b3", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class SecureValueTypeEmail extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("eea73c8e", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.data === undefined || this.data === false || this.data === null
          ? 0
          : 1 |
            (this.frontSide === undefined ||
              this.frontSide === false ||
              this.frontSide === null)
          ? 0
          : 2 |
            (this.reverseSide === undefined ||
      ...
      this.frontSide === null
        ? Buffer.alloc(0)
        : [this.frontSide.getBytes()],
      this.reverseSide === undefined ||
      this.reverseSide === false ||
      this.reverseSide === null
        ? Buffer.alloc(0)
        : [this.reverseSide.getBytes()],
      this.selfie === undefined || this.selfie === false || this.selfie === null
        ? Buffer.alloc(0)
        : [this.selfie.getBytes()],
      this.translation === undefined ||
      this.translation === false ||
      this.translation === null
        ? Buffer.alloc(0)
        : Buffer.concat([
            Buffer.from("15c4b51c", "hex"),
            struct.pack("<i", this.translation.length),
            Buffer.concat(this.translation.map((x) => x.getBytes())),
          ]),
      this.files === undefined || this.files === false || this.files === null
        ? Buffer.alloc(0)
        : Buffer.concat([
            Buffer.from("15c4b51c", "hex"),
            struct.pack("<i", this.files.length),
            Buffer.concat(this.files.map((x) => x.getBytes())),
          ]),
      this.plainData === undefined ||
      this.plainData === false ||
      this.plainData === null
        ? Buffer.alloc(0)
        : [this.plainData.getBytes()],
      TLObject.serializeBytes(this.hash),
    ]);
  }
  static fromReader(reader) {
...
class SecureValueHash extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _type = reader.tgReadObject();
    _hash = reader.tgReadBytes();
    return new this({ type: _type, hash: _hash });
  }
}
...
class SecureValueErrorFrontSide extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _file_hash = reader.tgReadBytes();
    _text = reader.tgReadString();
    return new this({ type: _type, fileHash: _file_hash, text: _text });
  }
}
...
class SecureValueErrorFiles extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      this.type.getBytes(),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.fileHash.length),
      Buffer.concat(this.fileHash.map((x) => TLObject.serializeBytes(x))),
      TLObject.serializeBytes(this.text),
    ]);
  }
  static fromReader(reader) {
...
class SecureValueError extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _hash = reader.tgReadBytes();
    _text = reader.tgReadString();
    return new this({ type: _type, hash: _hash, text: _text });
  }
}
...
class SecureCredentialsEncrypted extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _hash = reader.tgReadBytes();
    _secret = reader.tgReadBytes();
    return new this({ data: _data, hash: _hash, secret: _secret });
  }
}
...
class PasswordKdfAlgoUnknown extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("96b05ad4", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class PasswordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ salt1: _salt1, salt2: _salt2, g: _g, p: _p });
  }
}
...
class SecurePasswordKdfAlgoUnknown extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("37854a00", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputCheckPasswordEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("58f68098", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class InputCheckPasswordSRP extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ srpId: _srp_id, A: _A, M1: _M1 });
  }
}
...
class SecureRequiredType extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.nativeNames === undefined ||
          this.nativeNames === false ||
          this.nativeNames === null
          ? 0
          : 1 |
            (this.selfieRequired === undefined ||
              this.selfieRequired === false ||
              this.selfieRequired === null)
          ? 0
          : 2 |
            (this.translationRequired === undefined ||
              this.translationRequired === false ||
              this.translationRequired === null)
          ? 0
          : 4
      ),
      this.type.getBytes(),
...
class InputAppEvent extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _data = reader.tgReadObject();
    return new this({ time: _time, type: _type, peer: _peer, data: _data });
  }
}
...
class JsonNull extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("687b6d3f", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class JsonArray extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.value.length),
      Buffer.concat(this.value.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _value;
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.header === undefined ||
          ...
          ? 0
          : 16 |
            (this.valignMiddle === undefined ||
              this.valignMiddle === false ||
              this.valignMiddle === null)
          ? 0
          : 32 |
            (this.valignBottom === undefined ||
              this.valignBottom === false ||
              this.valignBottom === null)
          ? 0
          : 64 |
            (this.text === undefined ||
              this.text === false ||
      ...
      this.text === undefined || this.text === false || this.text === null
        ? Buffer.alloc(0)
        : [this.text.getBytes()],
      this.colspan === undefined ||
      this.colspan === false ||
      this.colspan === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.colspan)],
      this.rowspan === undefined ||
      this.rowspan === false ||
      this.rowspan === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.rowspan)],
    ]);
  }
  static fromReader(reader) {
    let _flags;
...
class PageTableRow extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.cells.length),
      Buffer.concat(this.cells.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _cells;
...
class PageCaption extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ text: _text, credit: _credit });
  }
}
...
class PageListOrderedItemText extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _text = reader.tgReadObject();
    return new this({ num: _num, text: _text });
  }
}
...
class PageListOrderedItemBlocks extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ num: _num, blocks: _blocks });
  }
}
...
class Page extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.part === undefined || this.part === false || this.part === null
          ? 0
          : 1 |
            (this.rtl === undefined || this.rtl === false || this.rtl === null)
          ? 0
          : 2 | (this.v2 === undefined || this.v2 === false || this.v2 === null)
          ? 0
          : 4
      ),
      TLObject.serializeBytes(this.url),
      ...
      Buffer.concat(this.blocks.map((x) => x.getBytes())),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.photos.length),
      Buffer.concat(this.photos.map((x) => x.getBytes())),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.documents.length),
      Buffer.concat(this.documents.map((x) => x.getBytes())),
    ]);
...
class PollAnswer extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ text: _text, option: _option });
  }
}
...
class Poll extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.answers.length),
      Buffer.concat(this.answers.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _id;
...
class PollAnswerVoters extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ chosen: _chosen, option: _option, voters: _voters });
  }
}
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.min === undefined || this.min === false || this.min === null
          ...
          ? 0
          : 2 |
            (this.totalVoters === undefined ||
              this.totalVoters === false ||
      ...
      this.results === null
        ...
        : Buffer.concat([
            Buffer.from("15c4b51c", "hex"),
            struct.pack("<i", this.results.length),
            Buffer.concat(this.results.map((x) => x.getBytes())),
          ]),
      this.totalVoters === undefined ||
      this.totalVoters === false ||
      this.totalVoters === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.totalVoters)],
    ]);
  }
  static fromReader(reader) {
    let _flags;
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.changeInfo === undefined ||
          ...
          ? 0
          : 2 |
            (this.editMessages === undefined ||
              this.editMessages === false ||
              this.editMessages === null)
          ? 0
          : 4 |
            (this.deleteMessages === undefined ||
              this.deleteMessages === false ||
              this.deleteMessages === null)
          ? 0
          : 8 |
            (this.banUsers === undefined ||
              this.banUsers === false ||
              this.banUsers === null)
          ? 0
          : 16 |
            (this.inviteUsers === undefined ||
              this.inviteUsers === false ||
              this.inviteUsers === null)
          ? 0
          : 32 |
            (this.pinMessages === undefined ||
              this.pinMessages === false ||
              this.pinMessages === null)
          ? 0
          : 128 |
            (this.addAdmins === undefined ||
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.viewMessages === undefined ||
          ...
          ? 0
          : 4 |
            (this.sendStickers === undefined ||
              this.sendStickers === false ||
              this.sendStickers === null)
          ? 0
          : 8 |
            (this.sendGifs === undefined ||
              this.sendGifs === false ||
              this.sendGifs === null)
          ? 0
          : 16 |
            (this.sendGames === undefined ||
              this.sendGames === false ||
              this.sendGames === null)
          ? 0
          : 32 |
            (this.sendInline === undefined ||
              this.sendInline === false ||
              this.sendInline === null)
          ? 0
          : 64 |
            (this.embedLinks === undefined ||
              this.embedLinks === false ||
              this.embedLinks === null)
          ? 0
          : 128 |
            (this.sendPolls === undefined ||
...
class CodeSettings extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.allowFlashcall === undefined ||
          this.allowFlashcall === false ||
          this.allowFlashcall === null
          ? 0
          : 1 |
          ...
          ? 0
          : 2 |
            (this.allowAppHash === undefined ||
              this.allowAppHash === false ||
              this.allowAppHash === null)
          ? 0
          : 16
      ),
    ]);
  ...
  static fromReader(reader) {
    ...
    return new this({
      allowFlashcall: _allow_flashcall,
...
class WallPaperSettings extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.blur === undefined || this.blur === false || this.blur === null
          ? 0
          : 2 |
      ...
      this.backgroundColor === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.backgroundColor)],
      this.intensity === undefined ||
      this.intensity === false ||
      this.intensity === null
        ? Buffer.alloc(0)
        : [struct.pack("<i", this.intensity)],
    ]);
  }
  static fromReader(reader) {
    let _flags;
    ...
    return Buffer.concat([
      ...
      struct.pack(
        ...
        this.disabled === undefined ||
          ...
          ? 0
          : 1 |
            (this.videoPreloadLarge === undefined ||
              this.videoPreloadLarge === false ||
              this.videoPreloadLarge === null)
          ? 0
          : 2 |
            (this.audioPreloadNext === undefined ||
              this.audioPreloadNext === false ||
              this.audioPreloadNext === null)
          ? 0
          : 4 |
            (this.phonecallsLessData === undefined ||
              this.phonecallsLessData === false ||
              this.phonecallsLessData === null)
          ? 0
          : 8
      ),
...
class EmojiKeyword extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.emoticons.length),
      Buffer.concat(this.emoticons.map((x) => TLObject.serializeBytes(x))),
    ]);
  }
  static fromReader(reader) {
    let _keyword;
    ...
    return new this({ keyword: _keyword, emoticons: _emoticons });
  }
}
...
class EmojiKeywordsDifference extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack("<i", this.version),
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.keywords.length),
      Buffer.concat(this.keywords.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _lang_code;
...
class FileLocationToBeDeprecated extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _volume_id = reader.readLong();
    _local_id = reader.readInt();
    return new this({ volumeId: _volume_id, localId: _local_id });
  }
}
...
class Folder extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack(
        "<I",
        this.autofillNewBroadcasts === undefined ||
          this.autofillNewBroadcasts === false ||
          this.autofillNewBroadcasts === null
          ? 0
          : 1 |
            (this.autofillPublicGroups === undefined ||
              this.autofillPublicGroups === false ||
              this.autofillPublicGroups === null)
          ? 0
          : 2 |
            (this.autofillNewCorrespondents === undefined ||
              this.autofillNewCorrespondents === false ||
              this.autofillNewCorrespondents === null)
          ? 0
          : 4 |
            (this.photo === undefined ||
              this.photo === false ||
  ...
  static fromReader(reader) {
    ...
    return new this({
      autofillNewBroadcasts: _autofill_new_broadcasts,
...
class InputFolderPeer extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _peer = reader.tgReadObject();
    _folder_id = reader.readInt();
    return new this({ peer: _peer, folderId: _folder_id });
  }
}
...
class UrlAuthResultDefault extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("1fdbd6a9", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class ChannelLocationEmpty extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("8badb5bf", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class ChannelLocation extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _geo_point = reader.tgReadObject();
    _address = reader.tgReadString();
    return new this({ geoPoint: _geo_point, address: _address });
  }
}
...
class PeerLocated extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ peer: _peer, expires: _expires, distance: _distance });
  }
}
...
class RestrictionReason extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _text = reader.tgReadString();
    return new this({ platform: _platform, reason: _reason, text: _text });
  }
}
...
class ThemeDocumentNotModified extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("0c273d48", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class ResPQ extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.serverPublicKeyFingerprints.length),
      Buffer.concat(
        this.serverPublicKeyFingerprints.map((x) =>
          readBufferFromBigInt(x, 8, true, true)
        )
      ),
    ]);
  }
...
class DestroyAuthKeyOk extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("d4e160f6", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class DestroyAuthKeyNone extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("59229f0a", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class DestroyAuthKeyFail extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("139b10ea", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class MsgsAck extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.msgIds.length),
      Buffer.concat(
        this.msgIds.map((x) => readBufferFromBigInt(x, 8, true, true))
      ),
    ]);
  }
  static fromReader(reader) {
...
class MsgsStateInfo extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ reqMsgId: _req_msg_id, info: _info });
  }
}
...
class MsgsAllInfo extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _info = reader.tgReadString();
    return new this({ msgIds: _msg_ids, info: _info });
  }
}
...
class RpcError extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ errorCode: _error_code, errorMessage: _error_message });
  }
}
...
class RpcAnswerUnknown extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("6ed32a5e", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class RpcAnswerDroppedRunning extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("86e578cd", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class RpcAnswerDropped extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _bytes = reader.readInt();
    return new this({ msgId: _msg_id, seqNo: _seq_no, bytes: _bytes });
  }
}
...
class FutureSalts extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack("<i", this.salts.length),
      Buffer.concat(this.salts.map((x) => x.getBytes().slice(4))),
    ]);
  }
  static fromReader(reader) {
    let _req_msg_id;
    ...
    return new this({ reqMsgId: _req_msg_id, now: _now, salts: _salts });
  }
}
...
class Pong extends TLObject {
  ...
  static fromReader(reader) {
    ...
    return new this({ msgId: _msg_id, pingId: _ping_id });
  }
}
...
class IpPort extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _port = reader.readInt();
    return new this({ ipv4: _ipv4, port: _port });
  }
}
...
class IpPortSecret extends TLObject {
  ...
  static fromReader(reader) {
    ...
    _port = reader.readInt();
    _secret = reader.tgReadBytes();
    return new this({ ipv4: _ipv4, port: _port, secret: _secret });
  }
}
...
class AccessPointRule extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      struct.pack("<i", this.dcId),
      struct.pack("<i", this.ips.length),
      Buffer.concat(this.ips.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    ...
    return new this({
      phonePrefixRules: _phone_prefix_rules,
      dcId: _dc_id,
      ips: _ips,
    });
  }
...
class TlsBlockDomain extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([Buffer.from("6f63e810", "hex")]);
  }
  static fromReader(reader) {
    let _x;
    let len;
...
class TlsBlockScope extends TLObject {
  ...
  getBytes() {
    return Buffer.concat([
      ...
      Buffer.from("15c4b51c", "hex"),
      struct.pack("<i", this.entries.length),
      Buffer.concat(this.entries.map((x) => x.getBytes())),
    ]);
  }
  static fromReader(reader) {
    let _entries;
